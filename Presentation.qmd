...
- 111 participants on Prolific completed the experiment
   - Majority white along yet with equal men and women
...
```{r}
#| label: fig-Experiment1PosteriorEffectSizes_1
#| fig.height: 12
#| fig.width: 12
...
```{r}
#| label: fig-Experiment2PosteriorEffectSizes_2
#| fig.height: 12
#| fig.width: 12
...
knitr::include_graphics("/Users/andrew/Documents/1_UoE/Research/PhD/Writing/Dissertation/Chapters/GraphsandTables/Chapter2/Mediation_fits/Mediation Figures/Mediation_a_b.png")
```
...
knitr::include_graphics("/Users/andrew/Documents/1_UoE/Research/PhD/Writing/Dissertation/Chapters/GraphsandTables/Chapter2/Mediation_fits/Mediation Figures/Mediation_c.png")
```
